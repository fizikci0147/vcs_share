   ...
   // cout<<"result is : " <<alpha_driver_dr_(&la,&qq2[0]) <<alpha_driver_dr_(&la,&qq2[1])<<endl;
    double S1=0.711,M1=1.,E1=1.;
       ...
       if(xs0!=xs0||xspi!=xspi) continue;
        ...
        gp0->SetPointError(0,0,g0->Eval(140)*sig0EE);
        gp0->SetPointError(1,0,g0->Eval(155)*sig0EE);
        ...
        gppi->SetPointError(0,0,g180->Eval(100)*sigpiEE);
        gppi->SetPointError(1,0,g180->Eval(120)*sigpiEE);
        gppi->SetPointError(2,0,g180->Eval(140)*sigpiEE);
        gppi->SetPointError(3,0,g180->Eval(155)*sigpiEE);
        gppi->SetPointError(4,0,g180->Eval(170)*sigpiEE);


        gpasy->SetPoint(0,140,gasy->Eval(140));
        gpasy->SetPoint(1,155,gasy->Eval(155));
        gpasy->SetPoint(2,170,gasy->Eval(170));


        gpasy->SetPointError(0,0.,GetAsyE(g0->Eval(140),g180->Eval(125),3,3));
        gpasy->SetPointError(1,0.,GetAsyE(g0->Eval(155),g180->Eval(145),3,3));
        gpasy->SetPointError(2,0.,GetAsyE(g0->Eval(170),g180->Eval(165),3,3));
