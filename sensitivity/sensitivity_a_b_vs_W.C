...
void sensitivity_a_b_vs_W(){
/*
 * Kin I
 */
    double W=0,la=0.7,lb=0.7, kin=2.2,kout ,kth,q2=0.35,thgg=140.*d2r,phcm0=0.*d2r,phcmpi=180.*d2r;
    ...
    */
    ...
    //kth *=d2r;
       ...
       if(xs0!=xs0||xspi!=xspi) continue;
        ...
        t->AddEntry(gla1_0,"la=0.1","l");
        t->AddEntry(g0,"la=0.7","l");
        t->AddEntry(gla2_0,"la=1.3","l");
       // t->AddEntry(glb1_0,"la=0.7,lb=0.1","l");
       // t->AddEntry(glb2_0,"la=0.7,lb=1.3","l");
        t->SetBorderSize(0);

        auto *gp0  = new TGraphErrors();
        auto *gppi = new TGraphErrors();

        gp0->SetPoint(0,1.17,g0->Eval(1.17));
        gp0->SetPoint(1,1.18,g0->Eval(1.18));
        gp0->SetPoint(2,1.19,g0->Eval(1.19));
        gp0->SetPoint(3,1.20,g0->Eval(1.20));
        gp0->SetPoint(4,1.21,g0->Eval(1.21));
        gp0->SetPoint(5,1.22,g0->Eval(1.22));
        gp0->SetPoint(6,1.23,g0->Eval(1.23));
        gp0->SetPoint(7,1.24,g0->Eval(1.24));
        gp0->SetPoint(8,1.25,g0->Eval(1.25));

        gp0->SetPointError(0,0,g0->Eval(1.17)*0.03);
        gp0->SetPointError(1,0,g0->Eval(1.18)*0.03);
        gp0->SetPointError(2,0,g0->Eval(1.19)*0.03);
        gp0->SetPointError(3,0,g0->Eval(1.20)*0.03);
        gp0->SetPointError(4,0,g0->Eval(1.21)*0.03);
        gp0->SetPointError(5,0,g0->Eval(1.22)*0.03);
        gp0->SetPointError(6,0,g0->Eval(1.23)*0.03);
        gp0->SetPointError(7,0,g0->Eval(1.24)*0.03);
        gp0->SetPointError(8,0,g0->Eval(1.25)*0.03);


        gppi->SetPoint(0,1.17,g180->Eval(1.17));
        gppi->SetPoint(1,1.18,g180->Eval(1.18));
        gppi->SetPoint(2,1.19,g180->Eval(1.19));
        gppi->SetPoint(3,1.20,g180->Eval(1.20));
        gppi->SetPoint(4,1.21,g180->Eval(1.21));
        gppi->SetPoint(5,1.22,g180->Eval(1.22));
        gppi->SetPoint(6,1.23,g180->Eval(1.23));
        gppi->SetPoint(7,1.24,g180->Eval(1.24));
        gppi->SetPoint(8,1.25,g180->Eval(1.25));

        gppi->SetPointError(0,0,g180->Eval(1.17)*0.03);
        gppi->SetPointError(1,0,g180->Eval(1.18)*0.03);
        gppi->SetPointError(2,0,g180->Eval(1.19)*0.03);
        gppi->SetPointError(3,0,g180->Eval(1.20)*0.03);
        gppi->SetPointError(4,0,g180->Eval(1.21)*0.03);
        gppi->SetPointError(5,0,g180->Eval(1.22)*0.03);
        gppi->SetPointError(6,0,g180->Eval(1.23)*0.03);
        gppi->SetPointError(7,0,g180->Eval(1.24)*0.03);
        gppi->SetPointError(8,0,g180->Eval(1.25)*0.03);
