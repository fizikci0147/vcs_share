   ...
   // cout<<"result is : " <<alpha_driver_dr_(&la,&qq2[0]) <<alpha_driver_dr_(&la,&qq2[1])<<endl;
    double S1=0.711,M1=1.,E1=1.;
       ...
       if(xs0!=xs0||xspi!=xspi) continue;
        ...
        gp0->SetPoint(0,125,g0->Eval(125));
        gp0->SetPoint(1,145,g0->Eval(145));
        gp0->SetPoint(2,165,g0->Eval(165));

        gp0->SetPointError(0,0,g0->Eval(125)*sig0EE);
        gp0->SetPointError(1,0,g0->Eval(145)*sig0EE);
        gp0->SetPointError(2,0,g0->Eval(165)*sig0EE);

        
        gppi->SetPoint(0,115,g180->Eval(115));
        gppi->SetPoint(1,125,g180->Eval(125));
        gppi->SetPoint(2,145,g180->Eval(145));
        gppi->SetPoint(3,165,g180->Eval(165));

        gppi->SetPointError(0,0,g180->Eval(115)*sigpiEE);
        gppi->SetPointError(1,0,g180->Eval(125)*sigpiEE);
        gppi->SetPointError(2,0,g180->Eval(145)*sigpiEE);
        gppi->SetPointError(3,0,g180->Eval(165)*sigpiEE);


        gpasy->SetPoint(0,125,gasy->Eval(125));
        gpasy->SetPoint(1,145,gasy->Eval(145));
        gpasy->SetPoint(2,165,gasy->Eval(165));


        gpasy->SetPointError(0,0.,GetAsyE(g0->Eval(125),g180->Eval(125),3,3));
        gpasy->SetPointError(1,0.,GetAsyE(g0->Eval(145),g180->Eval(145),3,3));
        gpasy->SetPointError(2,0.,GetAsyE(g0->Eval(165),g180->Eval(165),3,3));
