...
*/
   ...
   double W=1.230,la=0.7,lb=0.7, kin=3.3,kout ,kth,q2=0.45,thgg=0.*d2r,phcm0=0.*d2r,phcmpi=180.*d2r;
   double la1=0.1,la2=1.3,lb1=0.1,lb2=1.3;
   int model =5,ffact=4;
   double gp, gplab,Q20;
   Calckinvars(W,q2,kin,kth,kout,gp,gplab,Q20);
...
//Q2=0.05 alternative setting with E =1.1 to avoid elastic peak
   double W=1.230,la=0.7,lb=0.7, kin=1.1,kout ,kth,q2=0.05,thgg=0.*d2r,phcm0=0.*d2r,phcmpi=180.*d2r;
    double la1=0.1,la2=1.3,lb1=0.1,lb2=1.3;
    int model =5,ffact=4;
    double gp, gplab,Q20;
    Calckinvars(W,q2,kin,kth,kout,gp,gplab,Q20);
