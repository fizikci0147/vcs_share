...
void make_input_fit(double W =1.210){
    double la=0.7,lb=0.7, kin=2.2,kout ,kth,q2=0.45,thgg=0.*d2r,phcm0=0.*d2r,phcmpi=180.*d2r;
  ...
  //  double wdalpha[2] ={1.06e-4,1.09e-4};
   ...
   // cout<<"result is : " <<alpha_driver_dr_(&la,&qq2[0]) <<alpha_driver_dr_(&la,&qq2[1])<<endl;
    double S1=0.711,M1=1.,E1=1.;
        ...
        vector<int> thggl{100,120,140,155,170}; 
       ...
       cout<<kin <<" "<<thi << " "<<W << " " << q2<<" "<<0 <<" " <<180 <<" "<<xs0<<"  "<<xs0*0.03 <<" "<<xspi<<" "<<xspi*0.03 <<endl;
